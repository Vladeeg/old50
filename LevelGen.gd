...
#
#				var width:Int = 3 * FlxG.random.int(1, 3);
#				// var width:Int = 3;
#				if (x1 < x2) {
#					if (y1 < y2) {
#						mapData.fillRect(new Rectangle(x1, y1, Math.abs(x1 - x2), width), FlxColor.WHITE);
#						mapData.fillRect(new Rectangle(x2, y1, width, Math.abs(y1 - y2)), FlxColor.WHITE);
#					} else {
#						mapData.fillRect(new Rectangle(x1, y2, Math.abs(x1 - x2), width), FlxColor.WHITE);
#						mapData.fillRect(new Rectangle(x1, y2, width, Math.abs(y1 - y2)), FlxColor.WHITE);
#					}
#				} else {
#					if (y1 < y2) {
#						mapData.fillRect(new Rectangle(x2, y1, Math.abs(x1 - x2), width), FlxColor.WHITE);
#						mapData.fillRect(new Rectangle(x2, y1, width, Math.abs(y1 - y2)), FlxColor.WHITE);
#					} else {
#						mapData.fillRect(new Rectangle(x2, y2, Math.abs(x1 - x2), width), FlxColor.WHITE);
#						mapData.fillRect(new Rectangle(x1, y2, width, Math.abs(y1 - y2)), FlxColor.WHITE);
#					}
#				}
#			}
